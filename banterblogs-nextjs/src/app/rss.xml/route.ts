...
export async function GET() {
  try {
    ...
    const rss = [
      ...
      '    <description>Development log and research archive for the Chimera ecosystem — constitutional AI enforcement, multi-model debate, cryptographic provenance, and 752K+ research measurements across inference, optimization, and safety.</description>',
      `    <link>${BASE}</link>`,
