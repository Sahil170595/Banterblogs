      ...
      <header className="mb-10 md:mb-14 space-y-8 md:space-y-10">
        ...
        <div className="space-y-3 max-w-3xl pt-2">
          ...
          <DemoFidelity
            statement={
              <>
                All the crypto is real. The event format mirrors the Rust code&apos;s structure, but
                it hasn&apos;t been checked byte-for-byte against it.
              </>
            }
          >
            <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">
              <span className="font-mono text-foreground/80">Scope:</span> all crypto material on
              this page is real. The Ed25519 keypairs were generated by Node&apos;s native{' '}
