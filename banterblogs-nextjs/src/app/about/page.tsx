...
export const metadata: Metadata = {
  ...
  description:
    'Personal AI platform built by Sahil Kadadekar — 6 repos, 200K+ LOC, 126K+ research measurements, running on your hardware.',
};
    ...
    <div className="container py-16">
      ...
      <section className="mb-20">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="signal-panel p-6">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              126,000+ measurements across 30 technical reports. Not wall-clock approximations —
        ...
        <div className="space-y-3">
          {[
            ...
            },
            {
              ...
              loc: '32K LOC',
              lang: 'Python',
              what: 'ML research platform — inference API, benchmarking infrastructure, AutoOpt agent, safety evaluation framework. Source of 126K+ measurements.',
            },
            {
      ...
      <section className="mb-20">
        <div className="grid gap-4 grid-cols-2 md:grid-cols-4">
          {[
            ...
            { value: '30+', label: 'Technical Reports' },
      ...
      <section className="mb-20">
        ...
        <div className="signal-panel p-6 max-w-2xl">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            The research archive surfaces 30+ technical reports with phase grouping, searchable titles,
