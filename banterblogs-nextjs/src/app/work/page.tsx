...
export const metadata: Metadata = {
  title: 'Work',
  description:
    'ML Engineer · inference optimization, constitutional AI architectures, empirical safety evaluation. 5 papers submitted to NeurIPS 2026, 46 technical reports, 820K+ measurements.',
  openGraph: {
      ...
      <div className="signal-panel-strong mb-16 p-8 md:p-12">
        <div className="space-y-5 max-w-3xl">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            ...
            5 papers submitted to NeurIPS 2026, 46 technical reports, 820,000+ empirical measurements, and a
