...
export const metadata: Metadata = {
  ...
  description: "Personal AI platform running on your hardware — 6 repositories, 200K+ LOC, 555K+ research measurements, local inference with constitutional AI governance.",
  ...
  openGraph: {
    ...
    description: "Personal AI platform running on your hardware — local inference, constitutional AI governance, and 555K+ research measurements backing every decision.",
