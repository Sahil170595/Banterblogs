...
export function TrackingTicker({ system, position, total }: TrackingTickerProps) {
  ...
  return (
    <div
      ...
      aria-hidden="true"
      className="pointer-events-none absolute bottom-8 left-5 z-20 hidden max-w-[250px] sm:left-8 md:block"
    ...
    >
      ...
      >
        ...
        <p className="mt-1 text-muted-foreground">{system.blurb}</p>
      </div>
    </div>
  );
}
