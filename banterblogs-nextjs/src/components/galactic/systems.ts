...
export const STAR_SYSTEMS: StarSystemDef[] = [
  {
    ...
    a: 13.8, e: 0.12, inc: 0.10, node: 0.4, phase: 1.1, period: period(13.8),
  ...
  },
  {
    ...
    href: 'https://github.com/Sahil170595',
    a: 15, e: 0.28, inc: 0.22, node: 2.1, phase: 3.9, period: period(15),
  ...
  },
  {
    ...
    a: 11.8, e: 0.05, inc: 0.06, node: 5.2, phase: 0.2, period: period(11.8),
  ...
  },
  {
    ...
    href: 'https://github.com/Sahil170595',
    a: 16.5, e: 0.18, inc: 0.30, node: 1.2, phase: 5.0, period: period(16.5),
