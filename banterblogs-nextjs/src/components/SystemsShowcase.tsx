...
const coreEngines = [
  ...
  },
  {
    ...
    description:
      'Production research platform with CUDA event timing, quantization pipelines, TensorRT compilation, and capacity planning across 46 technical reports.',
    stats: ['820K+ measurements', '46 reports', '4 compilation backends'],
    href: '/reports',
