...
export const HERO_SUMMARY = `Architected Attunica's multimodal psychotherapy platform and AWS ECS/Bedrock cutover; at GhostEye (YC S25), shipped security agents to 5 enterprise pilots and cut deepfake-simulation latency from about 40s in early benchmarks to 100–450 ms per response. Built Chimera, a six-subsystem constitutional AI platform backed by ${REPORTS.DISPLAY} reports / ${MEASUREMENTS.SHORT} measurements, 6 first-author 2026 papers (1 presented at the ICML 2026 Workshop on Hypothesis Testing, 5 under double-blind review) plus 2 public arXiv preprints, four upstream contributions, ${HUGGING_FACE_MODELS} Hugging Face models, and two PyPI tools with ${COMBINED_PYPI_DOWNLOADS} downloads.`;
...
export const RESEARCH: ResearchItem[] = [
  ...
  },
  {
    ...
    href: '/reports',
    meta: `${REPORTS.DISPLAY} reports / ${MEASUREMENTS.SHORT} measurements · 1 presented + 5 under review + 2 preprints`,
    bullets: [
      ...
      'Led the independent program across training, deployment, and inference: consumer-GPU discovery with bounded A100 confirmation; pre-registered paired designs, bootstrap CIs, TOST, and Holm-Bonferroni. Presented at the ICML 2026 Workshop on Hypothesis Testing; 5 workshop submissions under double-blind review, spanning safety-embedding directions, judge prompt dependence, serving state, benchmark integrity, and speculative decoding; two studies public on arXiv, on quantization safety and temperature-zero speculative decoding. The program is sole-author.',
