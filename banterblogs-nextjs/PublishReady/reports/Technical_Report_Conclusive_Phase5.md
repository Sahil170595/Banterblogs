...
| **Primary Sources** | PublishReady/reports/Technical_Report_138_v2.md (Batch Safety Under Non-Determinism); PublishReady/reports/Technical_Report_139.md (Multi-Turn Jailbreak x Quantization); PublishReady/reports/Technical_Report_140.md (Many-Shot Long-Context Jailbreak); PublishReady/reports/Technical_Report_141.md (Cross-Architecture Refusal Fragility); PublishReady/reports/Technical_Report_142.md (Quality-Safety Correlation); PublishReady/reports/Technical_Report_143.md (Cross-Request Composition) |
