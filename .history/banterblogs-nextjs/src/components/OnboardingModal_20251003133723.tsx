...
const onboardingSteps = [
  ...
  },
  {
    ...
    content: "Coordinating three platforms: real-time overlay UX, production ML infrastructure, and automated storytelling means balancing <200ms latency, model quality, privacy compliance, and narrative clarity.",
    icon: "FX",
    features: ["Real-time overlay: Service Worker caching + <200ms render", "ML infrastructure: RLHF training without breaking live packs", "Privacy + compliance: GDPR anonymization + data retention", "CI/CD validation: schemas, packs, kernels, and episodes"]
  },
  {
    id: 7,
