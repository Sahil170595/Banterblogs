        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Watch the <strong className="text-accent">real-time creation</strong> of humanity&apos;s first personal AI assistant — from chaos to clarity, every commit tells our story.
            </p>
          </motion.div>
