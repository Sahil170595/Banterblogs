        ...
        <div className="flex flex-1 items-center justify-between space-x-2 md:justify-end">
          ...
          <nav className="flex items-center space-x-2 text-sm font-medium">
            ...
            <Link
              ...
              className="px-3 py-2 rounded-lg transition-all hover:text-fore hover:bg-primary/10 text-foreground/60 hover:shadow-lg hover:shadow-primary/10 hover:-translate-y-0.5 flex items-center space-x-1"
            >
              <span>GitHub</span>
