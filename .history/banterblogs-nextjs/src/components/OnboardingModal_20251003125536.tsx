...
const onboardingSteps = [
  ...
  {
    id: 3,
    title: "Banterhearts in 10 Seconds",
    content: "Banterhearts are lightweight viewer reactions that reward hype moments and help tune what shows up more often. They surface crowd favorites and can optionally unlock or boost special content.",
    icon: "❤️",
    features: ["Reward great moments", "Guide tone and variety", "Boost special content", "Simple viewer signal"]
  },
  {
    id: 4,
