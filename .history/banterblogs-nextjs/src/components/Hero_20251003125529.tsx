        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-2 max-w-2xl mx-auto">
              An automated devlog building <strong>Banterpacks</strong> and <strong>Banterhearts</strong>.
            </p>
            <p className="text-base text-muted-foreground mb-8 max-w-2xl mx-auto">
              Banterpacks: real-time AI overlay reacting to gameplay moments in <strong>&lt;200ms</strong>. 
              Banterhearts: lightweight viewer reactions that reward hype moments and tune what shows up more often.
            </p>
          </motion.div>
