...
const onboardingSteps = [
  ...
  },
  {
    ...
    content: "Gaming streams lose energy during queues, loading screens, and wipes. Banterpacks listens to game events and fills the silence with contextual banter routed across multiple LLM providers.",
    icon: "OP",
    features: ["Dead air elimination for lobbies and downtime", "Sub-200ms render path from event to overlay", "Provider routing across GPT-4, Claude, Gemini, and Ollama", "OBS/browser-source friendly deployment"]
  },
  {
    id: 3,
  ...
  },
  {
    ...
    content: "The blog layer ingests git history, registry manifests, CI artifacts, and Chimera Heart telemetry to auto-generate each episode with the four-character roundtable.",
    icon: "BB",
    features: ["Parses commits, diffs, and design docs for narrative beats", "Pulls build, test, and observability metrics into the script", "Maps changes to Claude/ChatGPT/Gemini/Banterpacks voices", "Ships new episodes without manual copywriting"]
  },
  {
    id: 5,
    title: "Why This Stack Is Hard",
    content: "Coordinating overlay UX, ML infrastructure, and automated storytelling means balancing latency, model quality, privacy, and clarity at once. Episodes document the trade-offs we made.",
    icon: "FX",
    features: ["Real-time overlay with multi-provider caching", "RLHF retraining without breaking live packs", "Privacy + compliance guardrails for feedback loops", "CI validating schemas, packs, kernels, and story output"]
  },
  {
    id: 6,
