        ...
        <div className="max-w-4xl mx-auto">
          <div className="rounded-xl border border-border bg-card/50 p-6">
            ...
            <p className="text-muted-foreground mb-4">
              This is an automated devlog following the build of <strong>Banterpacks</strong> and <strong>Banterhearts</strong>.
            </p>
            <div className="grid gap-4 md:grid-cols-2">
              <div className="p-4 rounded-lg border border-border bg-background/40">
                <div className="text-sm font-semibold mb-1">What is Banterpacks?</div>
                <p className="text-sm text-muted-foreground">
                  A real-time AI overlay that reacts to gameplay moments in <strong>&lt;200ms</strong> with contextual, witty banter.
                </p>
                <Link href="/about" className="text-xs text-primary mt-2 inline-block">Learn more →</Link>
              </div>
              <div className="p-4 rounded-lg border border-border bg-background/40">
                <div className="text-sm font-semibold mb-1">What are Banterhearts?</div>
                <p className="text-sm text-muted-foreground">
                  Lightweight viewer reactions that reward hype moments and help tune what shows up more often.
                </p>
                <Link href="/about#banterhearts" className="text-xs text-primary mt-2 inline-block">Learn more →</Link>
              </div>
            </div>
          </div>
        </div>
