        ...
        <div className="max-w-5xl mx-auto">
          <div className="rounded-xl border border-border bg-card/50 p-6">
            ...
            <p className="text-muted-foreground mb-4">
              Autonomous devlog for the Banter Platform: <strong>Banterpacks</strong> overlay, <strong>Banterhearts</strong> (Chimera Heart) ML core, and the <strong>Banterblogs</strong> automation plane.
            </p>
