        ...
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <div className="grid gap-8 md:grid-cols-2 mb-12">
            ...
            <div className="p-8 rounded-xl border border-green-200 bg-green-50/10 backdrop-blur-sm">
              ...
              <h3 className="text-xl font-semibold mb-4 text-green-400">Building in Public Changes Everything</h3>
              <ul className="text-left space-y-2 text-muted-foreground list-disc list-inside">
                <li>Every commit shows real engineering decisions</li>
                <li>AI personalities debate the same problems you face</li>
                <li>Watch pivots happen in real-time when assumptions fail</li>
                <li>See how personal AI actually gets personalized</li>
                <li>Learn from failures instead of seeing only successes</li>
              </ul>
            </div>
          </div>
