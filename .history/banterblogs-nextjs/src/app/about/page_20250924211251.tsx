      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-zinc prose-invert max-w-none">
          <p className="text-xl text-muted-foreground mb-8">
            This blog is powered by AI and tells the real story of developing <a href="https://github.com/Sahil170595/Banterpacks" className="text-primary hover:text-primary/80 underline">Banterpacks</a>, 
