  ...
  return (
    <div className="container py-16">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-gradient-black to-muted/20 rounded-2 rounded-xl p-8 border border-border mb-12">
          <h2 className="text-3xl font-bold mb-8">Open-Source Platform Capabilities</h2>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-purple-500/20 rounded-lg p-4">
                  ...
                  <div className="text-sm text-muted-foreground">
                    Single Docker Compose setup with Triton inference server
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-card/50 rounded-xl p-6 border border-border">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <div className="text-center">
                ...
                <div className="text-xs text-muted-foreground mmt-1">Banterhearts local</div>
              </div>
            </div>
          </div>
        </div>
