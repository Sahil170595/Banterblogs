    ...
    <div className="container py-16">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-gradient-black to-muted/20 rounded-2xl p-8 border border-border mb-12">
          <h2 className="text-3xl font-bold mb-8">Enterprise Gaming Content Platform</h2>
          
          <div className="grid gap-8 md:grid-cols-2 mb-8">
            {/* Platform vs Alternatives */}
            <div>
              <h3 className="text-xl font-bold mb-4">vs Traditional Streaming Platforms</h3>
              <div className="space-y-3">
                <div className="bg-muted/20 rounded-lg p-4">
                  <div className="font-semibold mb-2">Traditional: Static Overlays</div>
                  <div className="text-sm text-muted-foreground">
                    Fixed templates, manual updates, no intelligence, platform lock-in
                  </div>
                </div>
                
                <div className="bg-green-500/20 rounded-lg p-4">
                  <div className="font-semibold mb-2">Banter Platform: AI-Driven</div>
                  <div className="text-sm text-muted-foreground">
                    Dynamic responses, ML optimization, multi-platform deployment, self-improving
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Target Market */}
            <div>
              <h3 className="text-xl font-bold mb-4">Enterprise Customer Segments</h3>
              <div className="space-y-3">
                <div className="bg-blue-500/20 rounded-lg p-4">
                  <div className="font-semibold mb-2">Gaming Studios ($10K-50K ARR)</div>
                  <div className="text-sm text-muted-foreground">
                    Custom branded experiences, tournament integrations, analytics dashboards
                  </div>
                </div>
                
                <div className="bg-purple-500/20 rounded-lg p-4">
                  <div className="font-semibold mb-2">Streaming Platforms ($50K-200K ARR)</div>
                  <div className="text-sm text-muted-foreground">
                    White-label deployment, API access, SLA guarantees, enterprise support
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-card/50 rounded-xl p-6 border border-border">
            <h3 className="text-xl font-bold mb-4">ROI & Implementation</h3>
            <div className="grid gap-6 md:grid-cols-3">
              <div className="text-center">
                ...
                <div className="text-xs text-muted-foreground mt-1">Registry + Studio + Overlay</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-400 mb-2">$2K</div>
                <div className="text-sm text-muted-foreground">Average ARR Increase</div>
                <div className="text-xs text-muted-foreground mt-1">Per streamer engagement boost</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-purple-400 mb-2">99.9%</div>
                <div className="text-sm text-muted-foreground">SLA Guarantee</div>
                <div className="text-xs text-muted-foreground mt-1">Enterprise uptime</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-3 mb-12">
          ...
          <div className="bg-card/50 rounded-xl p-6 border border-border">
            ...
            <div className="space-y-4 mb-6">
              <div>
                <h4 className="font-semibold text-green-300 mb-2">Production ML Infrastructure</h4>
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>• <strong>Multi-service FastAPI</strong>: Inference (8001) + Ingestion (8002) + Training (8003)</li>
                  <li>• <strong>Enterprise data stack</strong>: PostgreSQL + Redis clusters + MinIO S3</li>
                  <li>• <strong>Container orchestration</strong>: Kubernetes deployments with health checks</li>
                  <li>• <strong>Data pipeline</strong>: Apache Kafka + Apache Airflow workflow orchestration</li>
                </ul>
              </div>
