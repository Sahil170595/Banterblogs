      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-blue-50/10 to-purple-50/10 rounded-2xl p-8 border border-border mb-12">
          ...
          <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
            A complete <strong>gaming content ecosystem</strong> combining real-time AI overlay technology, 
          ...
          <div className="bg-card/50 rounded-xl p-6 border border-border">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <div className="text-sm text-muted-foreground">Gaming Content Infrastructure</div>
              </div>
            </div>
            ...
            <div className="space-y-4 mb-6">
              ...
              <div>
                <h4 className="font-semibold text-blue-300 mb-2">Registry Service</h4>
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>• FastAPI with SQLite/PostgreSQL backends</li>
                  <li>• Manifest/shard architecture with ETag caching</li>
                  <li>• Stable/canary rollout controls</li>
                  <li>• Google OAuth2 authentication system</li>
                  <li>• Rate limiting & comprehensive API</li>
                </ul>
              </div>
              
              <div>
                <h4 className="font-semibold text-blue-300 mb-2">Studio Frontend</h4>
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>• React-based pack creation wizard (4-step)</li>
                  <li>• Rollout management & pack marketplace</li>
                  <li>• Provider diagnostics & health monitoring</li>
                  <li>• Preview system with OBS integration</li>
                </ul>
              </div>
            </div>
          ...
          <div className="bg-card/50 rounded-xl p-6 border border-border">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <div className="text-sm text-muted-foreground">Platform Brain Layer</div>
              </div>
            </div>
          ...
          <div className="bg-card/50 rounded-xl p-6 border border-border">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <div className="text-sm text-muted-foreground">ML Optimization Core</div>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-br from-gradient-black to-muted/20 rounded-2xl p-8 border border-border mb-12">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            {/* Data Flow */}
            <div>
              <h3 className="text-xl font-bold mb-4">Real-Time Data Flow</h3>
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <div className="font-semibold">Telemetry Collection</div>
                    <div className="text-sm text-muted-foreground">Overlay → Intelligence Pipeline → Banterhearts</div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <div className="font-semibold">ML Optimization</div>
                    <div className="text-sm text-muted-foreground">RLHF training → Model registry → Inference API</div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Registry rollouts → Overlay updates → Performance feedback</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* API Contracts */}
            <div>
              <h3 className="text-xl font-bold mb-4">API Integration Points</h3>
              <div className="space-y-4">
              <div className="bg-muted/20 rounded-lg p-4">
                <div className="font-mono text-sm font-medium">POST /api/v1/events</div>
                <div className="text-sm text-muted-foreground mt-1">Data collection endpoint for ML training pipeline</div>
              </div>
              
              <div className="bg-muted/20 rounded-lg p-4">
                <div className="font-mono text-sm font-medium">POST /api/v1/inference</div>
                <div className="text-sm text-muted-foreground mt-1">Model serving with &lt;100ms latency</div>
              </div>
              
              <div className="bg-muted/20 rounded-lg p-4">
                <div className="font-mono text-sm font-medium">GET /packs/{'{id}'}/manifest</div>
                <div className="text-sm text-muted-foreground mt-1">Rollout control API for content distribution</div>
              </div>
              </div>
            </div>
          </div>
