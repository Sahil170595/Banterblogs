    ...
    <div className="container py-16">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-zinc prose-invert max-w-none">
          ...
          <h2 className="text-2xl font-semibold mb-4">What are Banterhearts?</h2>
          <p className="text-muted-foreground mb-6">
            Banterhearts are <strong>lightweight viewer reactions</strong> that reward great moments and help tune what shows up more often.
            They act as a simple engagement signal that surfaces crowd favorites, nudges banter tone over time, and can optionally
            unlock or boost special content.
          </p>
