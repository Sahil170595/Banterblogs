        ...
        <div className="bg-gradient-to-br from-blue-50/10 to-purple-50/10 gradient-border rounded-2xl p-8 mb-12 noise-overlay">
          ...
          <div className="grid gap-4 md:grid-cols-3 mb-8">
            <div className="glass rounded-xl p-5">
              <div className="text-sm font-semibold mb-1">Banterpacks</div>
              <p className="text-sm text-muted-foreground">Real-time overlay (&lt;200ms), registry, and studio for gaming content.</p>
              <a href="#components-banterpacks" className="text-xs text-primary mt-2 inline-block">Learn more →</a>
            </div>
            <div className="glass rounded-xl p-5">
              <div className="text-sm font-semibold mb-1">Banterhearts</div>
              <p className="text-sm text-muted-foreground">Local ML core with Triton, RLHF loop, and optimized inference.</p>
              <a href="#components-banterhearts" className="text-xs text-primary mt-2 inline-block">Learn more →</a>
            </div>
            <div className="glass rounded-xl p-5">
              <div className="text-sm font-semibold mb-1">Intelligence Pipeline</div>
              <p className="text-sm text-muted-foreground">AI management layer for routing, health, and auto-optimization.</p>
              <a href="#components-intelligence" className="text-xs text-primary mt-2 inline-block">Learn more →</a>
            </div>
          </div>
          
          {/* Architecture Diagram */}
          <div className="bg-muted/20 glass-pro rounded-xl p-8 mb-8">
