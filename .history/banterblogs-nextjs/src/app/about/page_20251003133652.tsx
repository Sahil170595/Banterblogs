        ...
        <div className="bg-gradient-to-br from-gradient-black to-muted/20 rounded-2xl p-8 border border-border mb-12">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <div>
              ...
              </div else this section needs fixing
...
# Get pack manifest<br/>
curl localhost:8898/packs/epic-wins/manifest<br/>
<br/>
# Download pack assets<br/>
curl localhost:8898/packs/epic-wins/download -o epic-wins.zip<br/>
<br/>
# Check provider health panel<br/>
curl localhost:8898/health/providers
                ...
                <div className="bg-muted/20 rounded-lg p-4">
                  ...
                  <div className="bg-black/50 rounded p-3 font-mono text-sm text-green-400">
# Send feedback event<br/>
curl -X POST localhost:8002/api/v1/events \<br/>
&nbsp;&nbsp;-H "Content-Type: application/json" \<br/>
&nbsp;&nbsp;-d '{"event":"clutch","appreciation":0.92}'<br/>
<br/>
# Get AI inference<br/>
curl -X POST localhost:8001/api/v1/inference \<br/>
&nbsp;&nbsp;-H "Content-Type: application/json" \<br/>
