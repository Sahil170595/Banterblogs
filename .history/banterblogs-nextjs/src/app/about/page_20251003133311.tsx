            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="bg-muted/20 rounded-lg p-4">
                  ...
                  <div className="text-sm text-muted-foreground mt-1">Banterhearts data collection endpoint</div>
                </div>
                ...
                <div className="bg-muted/20 rounded-lg p-4">
                  ...
                  <div className="text-sm text-muted-foreground mt-1">Registry rollout control API</div>
                </div>
              </div>
            </div>
          </div>
