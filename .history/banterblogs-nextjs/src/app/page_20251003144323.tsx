          ...
          <div className="rounded-xl border border-border bg-card/50 p-6">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <div className="p-4 rounded-lg border border-border bg-background/40">
                <div className="text-sm font-semibold mb-1">Development Witness</div>
                <p className="text-sm text-muted-foreground">
                  Live documentation of AI assistant creation - from empty markdown files to full OAuth systems. Every commit tells a story.
                </p>
                <Link href="/about" className="text-xs text-primary mt-2 inline-block">Watch the evolution →</Link>
              </div>
              <div className="p-4 rounded-lg border border-border bg-background/40">
                <div className="text-sm font-semibold mb-1">The Chaos Narrative</div>
                <p className="text-sm text-muted-foreground">
                  AI personalities debate every technical decision, pivot, and breakthrough. See how real innovation emerges from the mess.
                </p>
                <Link href="/about" className="text-xs text-primary mt-2 inline-block">Read the debates →</Link>
              </div>
              <div className="p-4 rounded-lg border border-border bg-background/40">
                <div className="text-sm font-semibold mb-1">AI Assistant Blueprint</div>
                <p className="text-sm text-muted-foreground">
                  Complete technical roadmap showing how personal AI assistants actually get built - the architecture, challenges, and solutions.
                </p>
                <Link href="/about" className="text-xs text-primary mt-2 inline-block">Study the blueprint →</Link>
              </div>
            </div>
          </div>
        </div>
