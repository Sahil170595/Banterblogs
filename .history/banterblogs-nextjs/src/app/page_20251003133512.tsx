        ...
        <div className="max-w-5xl mx-auto">
          <div className="rounded-xl border border-border bg-card/50 p-6">
            ...
            <p className="text-muted-foreground mb-4">
              Autonomous devlog documenting private repositories: <strong>Banterpacks</strong> gaming platform, <strong>Banterhearts</strong> (Chimera Heart) ML infrastructure, and the <strong>Banterblogs</strong> automation plane.
            </p>
            <div className="grid gap-4 md:grid-cols-3">
              <div className="p-4 rounded-lg border border-border bg-background/40">
                <div className="text-sm font-semibold mb-1">Banterpacks Overlay</div>
                <p className="text-sm text-muted-foreground">
                  Real-time banter overlay reacting to gameplay moments in &lt;200ms using multi-LLM routing and speech interfaces.
                </p>
                <Link href="/about" className="text-xs text-primary mt-2 inline-block">Learn about the overlay</Link>
              </div>
              <div className="p-4 rounded-lg border border-border bg-background/40">
                <div className="text-sm font-semibold mb-1">Banterhearts (Chimera Heart)</div>
                <p className="text-sm text-muted-foreground">
                  RLHF + optimization platform ingesting viewer signals, training models inside 24 hours, and serving tuned responses with a &lt;100ms SLO.
                </p>
                <Link href="/about" className="text-xs text-primary mt-2 inline-block">Learn about the ML platform</Link>
              </div>
              <div className="p-4 rounded-lg border border-border bg-background/40">
                <div className="text-sm font-semibold mb-1">Banterblogs Automation</div>
                <p className="text-sm text-muted-foreground">
                  Automation layer converting commits, telemetry, and docs into the four-character episodes you are reading.
                </p>
                <Link href="/about" className="text-xs text-primary mt-2 inline-block">How it writes itself</Link>
              </div>
            </div>
          </div>
        </div>
