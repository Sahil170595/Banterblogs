        ...
        <div className="max-w-5xl mx-auto">
          <div className="rounded-xl border border-border bg-card/50 p-6">
            ...
            <p className="text-muted-foreground mb-4">
              <strong>Jarvis for Streamers</strong> - Your personal AI assistant that learns your style, manages your workflow, 
              and proactively helps during live content creation with voice-activated control and intelligent automation.
            </p>
