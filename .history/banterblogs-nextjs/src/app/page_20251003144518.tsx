      ...
      <section className="container py-16">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <div className="bg-gradient-to-r from-blue-900/20 to-purple-900/20 rounded-xl p-6 border border-blue-200/20 backdrop-blur-sm">
            <h4 className="text-lg font-semibold mb-3 text-blue-400">Your assistant&apos;s superpowers</h4>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-muted-foreground">
              <div className="flex items-center space-x-2">
                <span className="text-blue-400">🎙️</span>
                <span>Real-time voice commands</span>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span>Learning personality patterns</span>
              </div>
            </div>
          </div>
