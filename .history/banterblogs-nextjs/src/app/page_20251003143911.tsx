        ...
        <div className="max-w-5xl mx-auto">
          <div className="rounded-xl border border-border bg-card/50 p-6">
            ...
            <p className="text-muted-foreground mb-4">
              <strong>Building Jarvis in Public</strong> - Follow the real-time development diary of creating humanity's first truly personal AI assistant. 
              From streamer use cases to enterprise applications, watch every decision, pivot, and breakthrough as it happens.
            </p>
