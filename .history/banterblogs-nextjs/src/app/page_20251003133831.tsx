      ...
      <section className="container pt-8">
        <div className="max-w-5xl mx-auto">
          <div className="rounded-xl border border-border bg-card/50 p-6">
            <h2 className="text-xl font-semibold mb-2">Enterprise Platform Overview</h2>
            <p className="text-muted-foreground mb-4">
              Complete <strong>gaming content ecosystem</strong> with AI-powered real-time overlay, production ML infrastructure, and automated documentation: 
              private platform managing $100K+ ARR customers with 99.9% SLA guarantees.
            </p>
            <div className="grid gap-4 md:grid-cols-3">
              <div className="p-4 rounded-lg border border-border bg-background/40">
                <div className="text-sm font-semibold mb-1">Banterpacks Platform</div>
                <p className="text-sm text-muted-foreground">
                  Complete gaming content infrastructure: browser overlay (&lt;200ms), FastAPI registry, React Studio creation wizard, pack marketplace with rollout controls.
                </p>
                <Link href="/about" className="text-xs text-primary mt-2 inline-block">Platform architecture →</Link>
              </div>
              <div className="p-4 rounded-lg border border-border bg-background/40">
                <div className="text-sm font-semibold mb-1">Banterhearts (Chimera Heart)</div>
                <p className="text-sm text-muted-foreground">
                  Enterprise ML platform: multi-service FastAPI architecture, RLHF training pipelines, GPU hyperoptimization, model registry with A/B testing framework.
                </p>
                <Link href="/about" className="text-xs text-primary mt-2 inline-block">ML infrastructure →</Link>
              </div>
              <div className="p-4 rounded-lg border border-border bg-background/40">
                <div className="text-sm font-semibold mb-1">Intelligence Pipeline</div>
                <p className="text-sm text-muted-foreground">
                  AI-driven management layer: predictive analytics (&gt;90% accuracy), auto-optimization, self-healing infrastructure, real-time monitoring.
                </p>
                <Link href="/about" className="text-xs text-primary mt-2 inline-block">Integration details →</Link>
              </div>
            </div>
          </div>
        </div>
