          ...
          <div className="rounded-xl border border-border bg-card/50 p-6">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <div className="p-4 rounded-lg border border-border bg-background/40">
                <div className="text-sm font-semibold mb-1">Your AI Streaming Assistant</div>
                <p className="text-sm text-muted-foreground">
                  Real-time voice control, chat integration, and workflow automation that learns your streaming style and adapts to your audience preferences.
                </p>
                <Link href="/about" className="text-xs text-primary mt-2 inline-block">Assistant capabilities →</Link>
              </div>
              <div className="p-4 rounded-lg border border-border bg-background/40">
                <div className="text-sm font-semibold mb-1">Learning Engine (Chimera Heart)</div>
                <p className="text-sm text-muted-foreground">
                  Personalization layer that learns from your chat interactions, content preferences, and streaming patterns to provide increasingly helpful assistance.
                </p>
                <Link href="/about" className="text-xs text-primary mt-2 inline-block">Personalization details →</Link>
              </div>
              <div className="p-4 rounded-lg border border-border bg-background/40">
                <div className="text-sm font-semibold mb-1">Development Documentation</div>
                <p className="text-sm text-muted-foreground">
                  Automated devlogs showing how your personal AI assistant evolves and learns, bringing transparency to AI decision-making.
                </p>
                <Link href="/about" className="text-xs text-primary mt-2 inline-block">Documentation automation →</Link>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <div className="grid gap-8 md:grid-cols-2 mb-12">
            <div className="p-8 rounded-xl border border-red-200 bg-red-50/10 backdrop-blur-sm">
              ...
              <h3 className="text-xl font-semibold mb-4 text-red-400">Monologue Monotonous Managememt</h3>
              <ul className="text-left space-y-2 text-muted-foreground list-disc list-inside">
                <li>Constantly managing multiple streams of information</li>
                <li>Juggling chat, game audio, notifications, and transitions</li>
                <li>Everything requires manual interaction - no automation</li>
                <li>Can't focus on content while managing technical details</li>
                <li>Limited capacity to monitor audience sentiment in real-time</li>
              </ul>
            </div>
            ...
            <div className="p-8 rounded-xl border border-green-200 bg-green-50/10 backdrop-blur-sm">
              ...
              <h3 className="text-xl font-semibold mb-4 text-green-400">Your Personal AI Assistant</h3>
              <ul className="text-left space-y-2 text-muted-foreground list-disc list-inside">
                <li>Voice-activated control without breaking flow</li>
                <li>Proactive chat management and audience insights</li>
                <li>Automated scene transitions and content suggestions</li>
                <li>Focus on content while AI handles the details</li>
                <li>Learns your style and improves recommendations over time</li>
              </ul>
            </div>
          </div>
